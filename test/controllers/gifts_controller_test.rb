...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { availability: @gift.availability, description: @gift.description, name: @gift.name, user_id: @gift.user_id } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { availability: @gift.availability, description: @gift.description, name: @gift.name, user_id: @gift.user_id } }
